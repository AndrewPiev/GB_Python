...
@bot.message_handler(commands=['start', 'calc_real', 'calc_complex'])
# def get_message (message):
#     bot.send_message(message.from_user.id, 'Привет! Это калькулятор для действиетльных и комплексных чисел!', reply_markup=keyboard)
