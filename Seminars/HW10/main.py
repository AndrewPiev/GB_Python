...
def start(message):
    ...
    bot.send_message(chat_id=message.chat.id, text='<b>Привет! Я бот-калькулятор! Если хочешь что-то вычислить, то пиши мне. Не забывай. что на ноль делить нельзя! Для более подробной справки жми на кнопки, а если кнопок вдруг не стало видно, а они нужны, снова жми /start ;)))</b>', reply_markup=markup, parse_mode='html')
